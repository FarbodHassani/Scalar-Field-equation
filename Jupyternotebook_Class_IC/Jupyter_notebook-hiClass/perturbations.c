     ...
     if (fabs(a-1./(1+100.))<0.0008)
     {
       /**K is 1/Mpc */
        ...
        if( k>0.00001 )
        {
          ...
          // double deltarho_smg_Newt = 10000*(pi_prime_newton- psi_Sync); // scalar field in Newtonian gauge --> Gauge transformation: pi(Newt)=pi(Sync)+ alpha
          ...
          FILE * out1=fopen("./output/Kessence_field.dat","a");
          //  FILE * out2=fopen("./output/Kessence_field_alpha.dat","a");
          //  FILE * out2=fopen("./output/alpha_hi.dat","a");
          // fprintf(out2,"%e\t %e\t %e\t  \n",k,a,ppw->pvecmetric[ppw->index_mt_alpha]);
          // fprintf(out2,"%e\t %e\t %e\t  \n",k, a, );
          //  fprintf(out1,"%e\t %e\t %e\t %e\t %e\t %e\t %e\t \n",k, a, pi_newton, pi_synch, pi_prime_newton, ppw->pvecmetric[ppw->index_mt_vx_prime_smg],psi_Sync);
          fprintf(out1,"%e\t %e\t %e\t %e\t %e\t %e\t %e\t \n",k, a, pi_synch,ppw->pvecmetric[ppw->index_mt_vx_prime_smg],ppw->pvecmetric[ppw->index_mt_alpha]
          ,ppw->pvecmetric[ppw->index_mt_alpha_prime],psi_Sync);
          rintf("%e\t %e\t %e\t %e\t %e\t %e\t %e\t \n",k, a, pi_synch,ppw->pvecmetric[ppw->index_mt_vx_prime_smg],ppw->pvecmetric[ppw->index_mt_alpha]
          ,ppw->pvecmetric[ppw->index_mt_alpha_prime],psi_Sync);
